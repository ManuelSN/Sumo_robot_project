...
extern void timerEsperaRTI(void);
extern void ControlEncoders_sueloRTI(void);
extern void ControlEncoders_ruedaRTI(void);
...
void (* const g_pfnVectors[])(void) =
{
    ...
    ControlEncoders_sueloRTI,               // GPIO Port A
    ControlEncoders_ruedaRTI,               // GPIO Port B
    ...
    configADC_ISR,                          // ADC Sequence 3
    IntDefaultHandler,                      // Watchdog timer
    IntDefaultHandler,                      // Timer 0 subtimer A
    IntDefaultHandler,                      // Timer 0 subtimer B
    IntDefaultHandler,                 // Timer 1 subtimer A
    IntDefaultHandler,                      // Timer 1 subtimer B
    timerEsperaRTI,                         // Timer 2 subtimer A
